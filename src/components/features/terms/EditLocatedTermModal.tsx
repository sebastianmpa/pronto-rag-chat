      ...
      <div className="w-full max-w-md rounded-lg bg-white p-6 dark:bg-boxdark">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end space-x-3 pt-4">
            ...
            <button type="submit" disabled={loading} className="rounded bg-primary px-4 py-2 text-sm font-medium text-black hover:bg-opacity-90 disabled:opacity-50">{loading ? t('common.loading') : t('common.update')}</button>
          </div>
        </form>
      </div>
    </div>
